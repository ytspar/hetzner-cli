...
// including escaped fields from public auction JSON.
  ...
  private async handleKey(e: KeyboardEvent) {
    ...
    if (e.key === "Enter") {
      ...
      if (cmd) {
        ...
        if (result) {
          // Result is generated by the command system and formatter layer,
          // which escapes user input and public JSON fields before rendering.
